...
def parse_filename(filename):
    ...
    dataset = "MSV000088387"  # Replace with actual logic if needed
    run = filename
    ...
    species = "Homo Sapiens"  # Assuming human cell lines or tissues
...
df.to_csv('MSV000088387_annotated.csv', index=False)

print("CSV file has been created: MSV000088387_annotated.csv")
