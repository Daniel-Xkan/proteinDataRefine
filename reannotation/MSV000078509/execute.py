...
def parse_filename(filename):
    ...
    dataset = "MSV000078509"  # Replace with actual logic if needed
    run = filename
...
df.to_csv('MSV000078509_annotated.csv', index=False)

print("CSV file has been created: MSV000078509_annotated.csv")
